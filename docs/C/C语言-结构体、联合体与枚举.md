...
![image-20220228210247440](https://cdn.jsdelivr.net/gh/Lee-0o0/image-store/PicGo/2022-02-28/a3320bacd86b67dfe8ff2a3dd4d9b535--f995--image-20220228210247440.png)

由于**总线周期总是从偶地址（实际就是4的整数倍地址）开始读取数据**，那么只需要一个总线周期就能把变量a的值读出来。

如果变量`a`在内存中的存储位置如下：

![image-20220228210449169](https://cdn.jsdelivr.net/gh/Lee-0o0/image-store/PicGo/2022-02-28/9c32086a11c1a440fdb9da035d8efd0f--9dfa--image-20220228210449169.png)
...
![image-20220228212315008](https://cdn.jsdelivr.net/gh/Lee-0o0/image-store/PicGo/2022-02-28/cad24a6065708d822987406610bd2241--a3cb--image-20220228212315008.png)
